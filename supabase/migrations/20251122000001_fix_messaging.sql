-- Drop existing policies and view/table if they exist
DROP POLICY IF EXISTS "Users can view their own messages" ON messages;
DROP POLICY IF EXISTS "Users can send messages" ON messages;
DROP POLICY IF EXISTS "Users can update their sent messages" ON messages;
DROP POLICY IF EXISTS "Users can delete their own messages" ON messages;

-- Drop conversations (could be table or view) - VIEW first!
DROP VIEW IF EXISTS conversations CASCADE;
DROP TABLE IF EXISTS conversations CASCADE;

-- Drop and recreate messages table to ensure clean state
