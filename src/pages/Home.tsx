...
export default function Home() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      {/* Landscape - Bulut Benzeri Dalgalı Tepeler */}
      <div className="absolute bottom-0 left-0 right-0 h-[190px] md:h-[240px] lg:h-[300px] pointer-events-none z-0 opacity-95">
        {/* Tepeler katman 1 - en altta, en koyu - Bulut efekti */}
        <svg viewBox="0 0 1200 310" className="w-full h-full" preserveAspectRatio="none">
          <defs>
            <linearGradient id="cloudGrad1" x1="0%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" stopColor="rgba(167, 139, 250, 0.5)" stopOpacity="0.5" />
              <stop offset="100%" stopColor="rgba(196, 181, 253, 0.45)" stopOpacity="0.45" />
            </linearGradient>
          </defs>
          <path
            d="M 0,310 L 0,190 Q 120,175 250,190 Q 400,175 550,190 Q 700,175 850,190 Q 1000,175 1150,190 L 1200,190 L 1200,310 Z"
            fill="url(#cloudGrad1)"
            style={{
              filter: 'blur(3px) drop-shadow(0 -4px 8px rgba(15, 23, 42, 0.3))',
              transform: `translate3d(${mousePosition.x * 0.03}px, ${mousePosition.y * 0.03}px, 0)`,
              transition: 'transform 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
              willChange: 'transform'
            }}
        ...
        {/* Tepeler katman 2 - Bulut efekti */}
        <svg viewBox="0 0 1200 350" className="w-full h-full absolute top-0" preserveAspectRatio="none">
          <defs>
            <linearGradient id="cloudGrad2" x1="0%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" stopColor="rgba(167, 139, 250, 0.45)" stopOpacity="0.85" />
              <stop offset="100%" stopColor="rgba(96, 165, 250, 0.4)" stopOpacity="0.8" />
            </linearGradient>
          </defs>
          <path
            d="M 0,300 L 0,200 Q 150,185 300,200 Q 450,185 600,200 Q 750,185 900,200 Q 1050,185 1200,200 L 1200,300 Z"
            fill="url(#cloudGrad2)"
            style={{
              filter: 'blur(2.5px) drop-shadow(0 -3px 6px rgba(30, 41, 59, 0.25))',
              transform: `translate3d(${mousePosition.x * 0.025}px, ${mousePosition.y * 0.025 - 8}px, 0)`,
              transition: 'transform 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
              willChange: 'transform'
            }}
          />
        ...
        {/* Tepeler katman 3 - Bulut efekti */}
        <svg viewBox="0 0 1200 350" className="w-full h-full absolute top-0" preserveAspectRatio="none">
          <defs>
            <linearGradient id="cloudGrad3" x1="0%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" stopColor="rgba(167, 139, 250, 0.4)" stopOpacity="0.8" />
              <stop offset="100%" stopColor="rgba(196, 181, 253, 0.35)" stopOpacity="0.75" />
            </linearGradient>
          </defs>
          <path
            d="M 0,300 L 0,210 Q 180,195 360,210 Q 540,195 720,210 Q 900,195 1080,210 L 1200,210 L 1200,300 Z"
            fill="url(#cloudGrad3)"
            style={{
              filter: 'blur(2px) drop-shadow(0 -2.5px 5px rgba(51, 65, 85, 0.2))',
              transform: `translate3d(${mousePosition.x * 0.02}px, ${mousePosition.y * 0.02 - 15}px, 0)`,
              transition: 'transform 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
              willChange: 'transform'
            }}
          />
        ...
        {/* Tepeler katman 4 - Bulut efekti */}
        <svg viewBox="0 0 1200 350" className="w-full h-full absolute top-0" preserveAspectRatio="none">
          <defs>
            <linearGradient id="cloudGrad4" x1="0%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" stopColor="rgba(196, 181, 253, 0.4)" stopOpacity="0.75" />
              <stop offset="100%" stopColor="rgba(125, 211, 252, 0.35)" stopOpacity="0.7" />
            </linearGradient>
          </defs>
          <path
            d="M 0,300 L 0,220 Q 200,205 400,220 Q 600,205 800,220 Q 1000,205 1200,220 L 1200,300 Z"
            fill="url(#cloudGrad4)"
            style={{
              filter: 'blur(1.5px) drop-shadow(0 -2px 4px rgba(71, 85, 105, 0.18))',
              transform: `translate3d(${mousePosition.x * 0.015}px, ${mousePosition.y * 0.015 - 22}px, 0)`,
              transition: 'transform 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
              willChange: 'transform'
            }}
          />
        ...
        {/* Tepeler katman 5 - En üstteki küçük dalgalar - Bulut efekti */}
        <svg viewBox="0 0 1200 350" className="w-full h-full absolute top-0" preserveAspectRatio="none">
          <defs>
            <linearGradient id="cloudGrad5" x1="0%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" stopColor="rgba(244, 114, 182, 0.3)" stopOpacity="0.7" />
              <stop offset="100%" stopColor="rgba(196, 181, 253, 0.25)" stopOpacity="0.65" />
            </linearGradient>
          </defs>
          <path
            d="M 0,300 L 0,240 Q 250,230 500,240 Q 750,230 1000,240 L 1200,240 L 1200,300 Z"
            fill="url(#cloudGrad5)"
            style={{
              filter: 'blur(1px) drop-shadow(0 -1.5px 3px rgba(100, 116, 139, 0.15))',
              transform: `translate3d(${mousePosition.x * 0.01}px, ${mousePosition.y * 0.01 - 28}px, 0)`,
              transition: 'transform 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
              willChange: 'transform'
            }}
          />
