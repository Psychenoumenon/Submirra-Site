...
export default function Home() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-[190px] md:h-[240px] lg:h-[300px] pointer-events-none z-0 opacity-85">
        ...
        <svg viewBox="0 0 1200 310" className="w-full h-full" preserveAspectRatio="none">
          <defs>
            <linearGradient id="cloudGrad1" x1="0%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" stopColor="rgba(167, 139, 250, 0.4)" stopOpacity="0.35" />
              <stop offset="100%" stopColor="rgba(196, 181, 253, 0.35)" stopOpacity="0.3" />
            </linearGradient>
          </defs>
          <path
            ...
            fill="url(#cloudGrad1)"
            style={{
              filter: 'blur(5px) drop-shadow(0 -3px 6px rgba(15, 23, 42, 0.2))',
              transform: `translate3d(${mousePosition.x * 0.03}px, ${mousePosition.y * 0.03}px, 0)`,
              transition: 'transform 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
              willChange: 'transform'
            }}
        ...
        <svg viewBox="0 0 1200 350" className="w-full h-full absolute top-0" preserveAspectRatio="none">
          <defs>
            <linearGradient id="cloudGrad2" x1="0%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" stopColor="rgba(167, 139, 250, 0.35)" stopOpacity="0.8" />
              <stop offset="100%" stopColor="rgba(96, 165, 250, 0.3)" stopOpacity="0.75" />
            </linearGradient>
          </defs>
          <path
            ...
            fill="url(#cloudGrad2)"
            style={{
              filter: 'blur(4px) drop-shadow(0 -2px 4px rgba(30, 41, 59, 0.18))',
        ...
        <svg viewBox="0 0 1200 350" className="w-full h-full absolute top-0" preserveAspectRatio="none">
          <defs>
            <linearGradient id="cloudGrad3" x1="0%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" stopColor="rgba(167, 139, 250, 0.3)" stopOpacity="0.75" />
              <stop offset="100%" stopColor="rgba(196, 181, 253, 0.25)" stopOpacity="0.7" />
            </linearGradient>
          </defs>
          <path
            ...
            fill="url(#cloudGrad3)"
            style={{
              filter: 'blur(3px) drop-shadow(0 -2px 3px rgba(51, 65, 85, 0.15))',
        ...
        <svg viewBox="0 0 1200 350" className="w-full h-full absolute top-0" preserveAspectRatio="none">
          <defs>
            <linearGradient id="cloudGrad4" x1="0%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" stopColor="rgba(196, 181, 253, 0.3)" stopOpacity="0.7" />
              <stop offset="100%" stopColor="rgba(125, 211, 252, 0.25)" stopOpacity="0.65" />
            </linearGradient>
          </defs>
          <path
            ...
            fill="url(#cloudGrad4)"
            style={{
              filter: 'blur(2px) drop-shadow(0 -1px 2px rgba(71, 85, 105, 0.12))',
        ...
        <svg viewBox="0 0 1200 350" className="w-full h-full absolute top-0" preserveAspectRatio="none">
          <defs>
            <linearGradient id="cloudGrad5" x1="0%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" stopColor="rgba(244, 114, 182, 0.2)" stopOpacity="0.65" />
              <stop offset="100%" stopColor="rgba(196, 181, 253, 0.18)" stopOpacity="0.6" />
            </linearGradient>
          </defs>
          <path
            ...
            fill="url(#cloudGrad5)"
            style={{
              filter: 'blur(1px) drop-shadow(0 -0.5px 1px rgba(100, 116, 139, 0.1))',
